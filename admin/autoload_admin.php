        ...
        <table class="form-table table">
          ...
          <tr>
            <td colspan="3">
              ...
              <iframe height="20" width="84" frameborder="0" src="//www.draugiem.lv/say/ext/like.php?title=<?php echo urlencode('MediaBox.lv - WordPress mājas lapu izstrāde | Umbrovskis.com'); ?>&amp;url=<?php echo urlencode('https://mediabox.lv/') ?>&amp;titlePrefix=<?php echo urlencode(get_bloginfo('name')); ?>"></iframe>
            </td>
          </tr>
        </table>
        <p class="submit">
...
function smcwpd_help()
{
    ?><div class="wrap">
      ...
      <p>Spraudņa lapa: <a href="https://mediabox.lv/wordpress-draugiem/?utm_source=<?php echo urlencode(get_home_url()); ?>&utm_content=SMC-WPD-Help-link-pluginn-page&utm_medium=link&utm_campaign=WordPressDraugiem_<?php echo WPDRAUGIEMV; ?>" title="WordPress Draugiem" target="_blank">MediaBox.lv/wordpress-draugiem/</a></p>
      <h2>Lietošana</h2>
